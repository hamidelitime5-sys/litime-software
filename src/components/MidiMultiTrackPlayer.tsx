              ...
              <div className="space-y-2 max-h-[400px] overflow-y-auto pr-1">
                {playbackState.tracks.map((track) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`flex ${isDocked ? 'flex-col' : 'flex-row flex-nowrap'} items-stretch ${isDocked ? '' : 'items-center'} justify-between gap-2`}>
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-2">
                              {isRenaming ? (
                                ...
                                <div className="flex items-center gap-1.5 group min-w-0">
                                  <h5 className={`text-xs font-bold text-white truncate ${isDocked ? 'max-w-[110px]' : 'max-w-[140px] sm:max-w-[220px]'}`} title={track.name}>{track.name}</h5>
                                  <button
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              ...
                              >
                                ...
                                <span className={`truncate ${isDocked ? 'max-w-[130px]' : 'max-w-[180px] sm:max-w-xs'}`}>
                        ...
                        <div className={`flex items-center gap-1.5 flex-shrink-0 ${isDocked ? 'flex-wrap' : 'flex-nowrap'}`}>
                          {/* Test track button */}
                          <button
                          ...
                          {/* Pan Slider (CC 10) — hidden in the narrow docked side panel, only shown in the wide centered player */}
                          <div className={`items-center gap-1.5 w-24 bg-zinc-950 border border-zinc-800 px-2 py-1 rounded ${isDocked ? 'hidden' : 'hidden lg:flex'}`}>
